...
const Terms = () => {
  return (
    <div>
      ...
      <p>Welcome to harvisinfra!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of Harvisinfra's Website, located at https://harvisgroup.com/.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use harvisinfra if you do not agree to
      ...
      <p>
        We employ the use of cookies. By accessing harvisinfra, you agreed to
        use cookies in agreement with the Harvisinfra's Privacy Policy.{" "}
      </p>
      ...
      <p>
        Unless otherwise stated, Harvisinfra and/or its licensors own the
        intellectual property rights for all material on harvisinfra. All
        intellectual property rights are reserved. You may access this from
        harvisinfra for your own personal use subjected to restrictions set in
        these terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from harvisinfra</li>
        <li>Sell, rent or sub-license material from harvisinfra</li>
        <li>Reproduce, duplicate or copy material from harvisinfra</li>
        <li>Redistribute content from harvisinfra</li>
      </ul>
      ...
      <p>
        ...
        Harvisinfra does not filter, edit, publish or review Comments prior to
        their presence on the website. Comments do not reflect the views and
        opinions of Harvisinfra,its agents and/or affiliates. Comments reflect
        the views and opinions of the person who post their views and opinions.
        To the extent permitted by applicable laws, Harvisinfra shall not be
      ...
      <p>
        Harvisinfra reserves the right to monitor all Comments and to remove any
      ...
      <p>
        You hereby grant Harvisinfra a non-exclusive license to use, reproduce,
      ...
      <p>
        ...
        the hyperlink compensates the absence of Harvisinfra; and (d) the link
      ...
      <p>
        ...
        e-mail to Harvisinfra. Please include your name, your organization name,
      ...
      <p>
        No use of Harvisinfra's logo or other artwork will be allowed for
